...
//
//  /**
//   * Equipment Test 1 Tests creating a request, query, and then adding that to the request list,
// and
...
//
//  /**
//   * Gift Test 1 Tests creating a request, query, and then adding that to the request list, and
// then
//   * accessing that added node in the list of existing requests to see if it was saved.
//   */
//  @Test
//  public void GiftQuery() {
//    GiftRequest giftTest = new GiftRequest("123", "567", "active", "GiftRequest", "Jack",
// "Candy");
...
//
//  /**
//   * Maintenance Request Test 1 Tests creating a request, query, and then adding that to the
// request
//   * list, and then accessing that added node in the list of existing requests to see if it was
//   * saved.
//   */
...
//        new MedicineRequest("123", "567", "Active", "Medicine", "Jack", "Advil", "x1",
// "immediate");
...
//        new SecurityRequest("123", "567", "Active", "Security", "Jack", "L1", "Armed",
// "Immediate");
